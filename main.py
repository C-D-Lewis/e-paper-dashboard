...
FONT_24 = ImageFont.truetype(os.path.join(FONTS_DIR, 'KeepCalm-Medium.ttf'), 24)
...
def draw_weather(canvas, image):
  image.paste(ICON_CLOUD, (450, 15))
  canvas.text((540, 10), weather_data['current_summary'], font = FONT_24, fill = 0)
